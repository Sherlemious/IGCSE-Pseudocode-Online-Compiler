      ...
      <div className="w-full max-w-sm relative animate-fade-in-up">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-dark-text mt-1.5">
            Sign in to track progress and unlock questions
          </p>
        </div>

        {/* Auth card */}
        <div className="bg-surface/80 backdrop-blur-sm rounded-xl border border-border p-6 card-glow" style={{ animationDelay: '100ms' }}>
          {/* OAuth providers */}
          <div className="space-y-2.5 stagger-children">
            ...
            >
              ...
              >
                ...
                <span className="group-hover:translate-x-0.5 transition-transform duration-200">Continue with GitHub</span>
              </button>
            </form>
          </div>
