...
import { Settings, Minus, Plus, Check, WrapText, Palette } from 'lucide-react';
import {
  themes,
  type PresetThemeId,
  useTheme,
...
export default function SettingsPanel() {
  ...
  function handleSaveCustom(colors: CustomColors) {
  ...
  return (
    <>
          ...
          >
            ...
            <div>
              ...
              <div className="mt-3 space-y-1">
                ...
                >
                  <div
                    className="w-4 h-4 rounded-full border border-current/20 flex-shrink-0 ring-1 ring-current/10"
                ...
                >
                  <Palette size={12} />
                  {themeId === 'custom' ? 'Edit custom theme…' : 'Create custom theme…'}
                </button>
              </div>
            </div>
      ...
      {/* Theme editor modal — rendered via portal outside the popover */}
      {editorOpen && (
        <ThemeEditorModal
          colors={customColors}
